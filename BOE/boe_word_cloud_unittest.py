...
class TestWordCloudGeneration(unittest.TestCase):
    ...
    def test_word_cloud_file(self):
        ...
        self.file1=f'../wordcloud/{self.word_cloud_generation.folder_dict[self.bank]}/2023-02-20_ Sam Woods.png'
        self.file2= f'../wordcloud/{self.word_cloud_generation.folder_dict[self.bank]}/2023-02-16_ Huw Pill.png'
